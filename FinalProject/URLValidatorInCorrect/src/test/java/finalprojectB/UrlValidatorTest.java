...
public class UrlValidatorTest  {
   ...
   public void testManual()
   {
	  ...
	  // assertTrue(urlValidator.isValid(validUrl));		// Bug found
   ...
   public void BigStrings()
   {
	   ...
	   assertFalse(bigTest.isValid("https://www.hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiilllllllllllllllllllllllllllllllll.com"));
	   assertFalse(bigTest.isValid("https://www.SLKDJFALKSDJFLAKSDJFLAKSDJFALKSDFJLAKSDFJALKSDJFLASKDFJALSKDFJLAKSDFJLAKSDFJALSKDFJASKLDFJASKLDFJFJASKLFJASDKLFJASKLFJASKLFJASDFKLJASDFKLJASDFKL"
 ...
 //Checking small and null strings
   ...
   public void SmallStrings()
   {
	   ...
	   assertFalse(smallTest.isValid("https://h.com"));
   ...
   public void AnyAuthority()
   {
	   ...
	   //assertTrue(anyAuth.isValid("hergeshers://www.gmail.com"));				// Bug found
	   //assertTrue(anyAuth.isValid("hergeshers://192.168.0.1"));				// Bug found
	   //assertFalse(anyAuth.isValid("blah://1."));								// Bug found
	   //assertFalse(anyAuth.isValid("blah://1.02"));							// Bug found
	   //assertFalse(anyAuth.isValid("blah://www.google.com//doubleslash"));	// Bug found	   
   }
   ...
   public void MaxIP(){
		 ...
		 //assertTrue(tester.isValid("https://255.255.255.255"));	// Bug found
		 //assertTrue(tester.isValid("https://255.255.255.254"));	// Bug found
		 //assertTrue(tester.isValid("https://255.255.254.255"));	// Bug found
		 //assertTrue(tester.isValid("https://255.254.255.255"));	// Bug found
		 //assertTrue(tester.isValid("https://254.255.255.255"));	// Bug found
   ...
   public void MinIP(){
		 ...
		 //testing good high numbers
		 //assertTrue(tester.isValid("https://0.0.0.0"));				// Bug found
		 //assertTrue(tester.isValid("https://0.0.0.1"));				// Bug found
		 //assertTrue(tester.isValid("https://1.2.3.4"));				// Bug found
		 //assertTrue(tester.isValid("https://6.5.4.3"));				// Bug found
		 //assertTrue(tester.isValid("https://1.1.1.0"));				// Bug found
		 
		 //testing bad high numbers
		 assertFalse(tester.isValid("https://-1.-1.-1.-1"));			// Bug found
		 assertFalse(tester.isValid("https://0.0.0.0"));				// Bug found
		 assertFalse(tester.isValid("https://-255.-255.-255.-255"));	// Bug found
   ...
   public void Ports() {
	   ...
	   //testing good ports
	   //assertTrue(portTest.isValid("https://192.168.0.1:12"));		// Bug found
	   //assertTrue(portTest.isValid("https://192.168.0.1:13"));		// Bug found
	   //assertTrue(portTest.isValid("https://192.168.0.1:65000"));		// Bug found
	   //assertTrue(portTest.isValid("https://192.168.0.1:1"));			// Bug found
	   //assertTrue(portTest.isValid("https://192.168.0.1:1567"));		// Bug found
